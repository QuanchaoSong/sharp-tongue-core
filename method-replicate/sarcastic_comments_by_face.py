...
class Sacarstic_Comments_By_Face:
    ...
    def __analyze_PIL_image(self, PIL_image):
        ...
        print("face_basic_info:", self.face_basic_info)
        ...
        print("attractiveness_value:", self.attractiveness_value)
        self.basic_scene = self.__generate_basic_scene()
        print("basic_scene:", self.basic_scene)
        self.adj_and_antonym_pair_list = self.__get_adj_and_antonym_list()
        print("adj_and_antonym_pair_list:", self.adj_and_antonym_pair_list)
        self.opposite_analogy_list = self.__get_opposite_analogies()
        print("opposite_analogy_list:", self.opposite_analogy_list)
...
if __name__ == '__main__':
    ...
    res = tool_for_face.analyse_image_url("https://i.pinimg.com/564x/fc/31/97/fc319721d6e27a93468e38656a4e3092.jpg")
    print("res:", res)