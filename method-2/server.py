...
def analyze_image_url():
    ...
    (elements, comments_by_elements, comment_by_context) = tool_for_comments.analyse_image_url(image_url)
...
def analyze_image_data():
    ...
    (elements, comments_by_elements, comment_by_context) = tool_for_comments.analyse_image_data(img_data)
